...
public interface IConstants {
     ...
     */
    String GCM_SEND_ENDPOINT = "https://gcm-http.googleapis.com/gcm/send";
     ...
     */
    String PARAM_PAYLOAD_PREFIX = "data.";

    /**
     * Parameter used to set the message time-to-live.
     */
    String PARAM_TIME_TO_LIVE = "time_to_live";
     ...
     */
    String PARAM_CONTENT_AVAILABLE = "content_available";

    /**
     * Value used to set message priority to normal.
     */
    String MESSAGE_PRIORITY_NORMAL = "normal";

    /**
     * Value used to set message priority to high.
     */
    String MESSAGE_PRIORITY_HIGH = "high";

    /**
     * Too many messages sent by the sender. Retry after a while.
     */
    String ERROR_QUOTA_EXCEEDED = "QuotaExceeded";

    /**
     * Too many messages sent by the sender to a specific device.
     * Retry after a while.
     */
    String ERROR_DEVICE_QUOTA_EXCEEDED =
            "DeviceQuotaExceeded";
     ...
     */
    String ERROR_UNAVAILABLE = "Unavailable";
     ...
     */
    String JSON_MESSAGE_ID = "message_id";
