package org.lyj.ext.selenium.controllers.routines.controller.scripts.tools.utils;
...
public class Tool_error
    ...
    public Tool_error(final ScriptProgram program) {
        super(NAME, program);

        _package_name = super.info().name();
    }
