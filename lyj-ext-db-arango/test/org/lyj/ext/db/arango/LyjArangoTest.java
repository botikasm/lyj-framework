...
/**
 * Created by angelogeminiani on 23/11/16.
 */
public class LyjArangoTest {
    ...
    @Test
    public void test() {
        final ArangoDB arangoDB = new ArangoDB.Builder().host("localhost").port(8529).user("root").password("").build();
        ...
        final Collection<String> names = arangoDB.getDatabases();
