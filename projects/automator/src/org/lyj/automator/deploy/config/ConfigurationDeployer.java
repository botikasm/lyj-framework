...
package org.lyj.automator.deploy.config;


import org.lyj.commons.io.repository.deploy.FileDeployer;

public class ConfigurationDeployer extends FileDeployer {

    // ------------------------------------------------------------------------
    //                      c o n s t r u c t o r
    // ------------------------------------------------------------------------

    public ConfigurationDeployer(final String targetFolder, final boolean silent) {
        super("", targetFolder,
