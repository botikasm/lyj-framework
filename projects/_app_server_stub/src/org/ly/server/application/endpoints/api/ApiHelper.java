package org.ly.server.application.endpoints.api;

import org.json.JSONObject;
import org.ly.server.application.endpoints.TokenController;
import org.ly.server.i18n.templates.Templates;
...
public abstract class ApiHelper {
    ...
    public static JSONObject wrapResponse(final Object obj) {
        ...
        if (obj instanceof Map) {
            ...
            response.put(FLD_RESPONSE, Converter.toJsonArray(obj));
        } else {
    ...
    public static void writeHTMLError(final HttpServerContext context) {
        ...
        final String html = Templates.instance().getTemplateHTML(lang, TemplatesHtml.TPL_ERROR,
                MapBuilder.createSS().put(TemplatesHtml.FLD_ERROR, "").toMap());
