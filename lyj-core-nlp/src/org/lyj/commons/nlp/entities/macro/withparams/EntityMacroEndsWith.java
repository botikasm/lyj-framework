...
public class EntityMacroEndsWith
    ...
    public static final String NAME = "endsWith"; // detects names of persons (first should be Uppercase)
    ...
    public EntityMacroEndsWith(final String[] args) {
        super(NAME, args);
    ...
    public String[] parse(final String lang,
        ...
        for (int i = start_index; i < phrase.length; i++) {
            ...
            if (StringUtils.hasText(_text) && word.endsWith(_text)) {
                result.add(word);
            }
        }
