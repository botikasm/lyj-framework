 ...
 * <p/>
 * <p>to compressJs the data before encoding it and then making the output have no newline characters.</p>
 * <p/>
 * <p/>
 * <p>
 * Change Log:
 ...
 * Added the ability to GZip-compressJs objects before encoding them.</li>
...
public class Base64 {
     ...
     * Preferred encoding.
     */
    private final static String PREFERRED_ENCODING = "UTF-8";    // I think I end up not using the BAD_ENCODING indicator.
...
-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9         // Decimal 244 - 255 */};
     ...
     * @since 1.4
     */
    public static String encodeObject(final Object serializableObject) {
    ...
    public static String encodeObject(final Object serializableObject,
        ...
        if (serializableObject instanceof Serializable) {
            ...
            try {
                ...
                LoggingUtils.getLogger(Base64.class).log(Level.SEVERE, null, e);
                return null;
            } // end catch
            finally {
                try {
    ...
    public static String encodeBytes(byte[] source, int off, int len, int options) {
        ...
        // Else, don't compressJs. Better not to use streams at all then.
        else {
    ...
    public static byte[] decode(byte[] source, int off, int len, int options) {
        ...
        for (i = off; i < off + len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) // White space, Equals sign or better
            {
                ...
                LoggingUtils.getLogger().fine("Bad Base64 input character at "
                        + i + ": " + source[i] + "(decimal)");
                return null;
            }   // end else:
    ...
    public static Object decodeToObject(String encodedObject) {
        if (!StringUtils.hasText(encodedObject)) {
            return null;
        }
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            while ((numBytes = bis.read(buffer, length, 4096)) >= 0) {
                length += numBytes;            // Save in a variable to return
            }
    ...
    public static boolean encodeFileToFile(String infile, String outfile) {
        ...
        try {
            ...
            LoggingUtils.getLogger(Base64.class).log(Level.SEVERE, null, exc);
        } finally {
            try {
                in.close();
            } catch (Exception exc) {
