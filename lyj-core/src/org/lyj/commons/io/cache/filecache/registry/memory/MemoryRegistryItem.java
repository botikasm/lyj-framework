 ...
 *
 */
public class MemoryRegistryItem
    ...
    public MemoryRegistryItem() {
        _data = new JsonWrapper(new JSONObject());
        this.duration(DEFAULT_LIFE);
    }


    public MemoryRegistryItem(final JSONObject item) {
    ...
    public MemoryRegistryItem path(final String path) {
    ...
    public MemoryRegistryItem uid(final String value) {
    ...
    public MemoryRegistryItem duration(final long value) {
