 ...
 * made except when the image is saved out, e.g. using {@link javax.imageio.ImageIO}.
 * <p>
 ...
 * <h3>Thread Safety</h3>
 * The {@link Resize} class is <strong>thread-safe</strong> (as all the methods
...
public class Resize {
    ...
    public static enum Method {
         ...
         * {@link Resize#THRESHOLD_QUALITY_BALANCED} or
         * {@link Resize#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
    ...
    public static enum Mode {
         ...
         * <p>
         * See "Image Proportions" in the {@link Resize} class description for
         * more detail.
         */
        AUTOMATIC,
        /**
     ...
     * type that is poorly supported. Unfortunately using {@link javax.imageio.ImageIO} and
    ...
    public static BufferedImage resizeMin(BufferedImage src,
                                          int minSize,
                                          BufferedImageOp... ops)
            throws IllegalArgumentException, ImagingOpException {
        ...
        if (w > h) {
            // landscape
            return resize(src, Method.AUTOMATIC, Mode.FIT_TO_HEIGHT, minSize, minSize, ops);
        } else {
            // portrait
            return resize(src, Method.AUTOMATIC, Mode.FIT_TO_WIDTH, minSize, minSize, ops);
        }
    }
     ...
     * {@link Resize#DEBUG} is <code>true</code>; otherwise the VM will be
     ...
     * @see Resize#LOG_PREFIX
     * @see Resize#LOG_PREFIX_PROPERTY_NAME
     */
    protected static void log(int depth, String message, Object... params) {
        if (Resize.DEBUG) {
            System.out.print(Resize.LOG_PREFIX);
     ...
     * method utilizes the {@link Resize#THRESHOLD_QUALITY_BALANCED} and
     * {@link Resize#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
    ...
    protected static Method determineScalingMethod(int targetWidth,
        ...
        if (length <= Resize.THRESHOLD_QUALITY_BALANCED)
            result = Method.QUALITY;
        else if (length <= Resize.THRESHOLD_BALANCED_SPEED)
