...
import org.lyj.commons.mutex.Mutex;
import org.lyj.commons.mutex.MutexPool;
import org.lyj.commons.remoting.Remoting;
...
// ------------------------------------------------------------------------
    ...
    public String decode(final String s) {
        try {
            return URLDecoder.decode(s, Lyj.getCharset());
    ...
    private String decodeWhile(final String s) {
        String result = s;
        try {
            result = URLDecoder.decode(result, Lyj.getCharset());
