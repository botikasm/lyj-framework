 ...
 * </p>
 */
public class LyjClassLoader extends URLClassLoader {

    public LyjClassLoader() {
        this(new URL[0]);
    }

    public LyjClassLoader(final URL[] urls) {
        this(urls, LyjClassLoader.class.getClassLoader());
    }

    public LyjClassLoader(final File home, final String[] classpath)
    ...
    public LyjClassLoader(final URL[] urls, final ClassLoader parent) {
        super(urls, parent);
    }
