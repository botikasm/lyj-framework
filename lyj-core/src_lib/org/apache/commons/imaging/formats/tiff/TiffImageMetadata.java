...
public class TiffImageMetadata extends ImageMetadata implements
    ...
    public static class Directory extends ImageMetadata implements
        ...
        public TiffOutputDirectory getOutputDirectory(final ByteOrder byteOrder)
            ...
            try {
                ...
                final List<? extends IImageMetadata.IImageMetadataItem> entries = getItems();
    ...
    public List<? extends IImageMetadata.IImageMetadataItem> getItems() {
        final List<IImageMetadata.IImageMetadataItem> result = new ArrayList<IImageMetadata.IImageMetadataItem>();

        final List<? extends IImageMetadata.IImageMetadataItem> items = super.getItems();
    ...
    public TiffOutputSet getOutputSet() throws ImageWriteException {
        ...
        final List<? extends IImageMetadata.IImageMetadataItem> srcDirs = getDirectories();
        for (int i = 0; i < srcDirs.size(); i++) {
            final Directory srcDir = (Directory) srcDirs
                    .get(i);
    ...
    public TiffField findField(final TagInfo tagInfo, final boolean exactDirectoryMatch)
        ...
        final List<? extends IImageMetadata.IImageMetadataItem> directories = getDirectories();
